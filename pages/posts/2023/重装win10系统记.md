...
另外，使用某些搜索引擎时，需要特别注意：排名靠前的结果，有可能不是指向官网。

### Q: 笔记本使用电池时的色彩显示问题？

之前我对这台笔记本唯一不满意的点就是不插电源使用时，屏幕亮度和色彩准确度都下降了一个档次。

很长时间也没有找到解决方案，直到我重新安装了 AMD 官方的显卡驱动软件，在 [AMD 驱动程序与支持](https://www.amd.com/zh-hans/support) 根据自己的 CPU 类型搜索，最后找到 "AMD Software: Adrenalin Edition" 这个进行下载安装（注：我在首次安装时失败，不过按提示重新设置一下就可以了）。这下终于不插电也可以愉快使用了。
...
1.  我为什么不继续使用 win11 呢？
    ...
    - win11 的 UI 交互在我看来更偏向于触屏方式，我个人不是很习惯：
      - 底部任务栏太大了，特别是在我这"寸土寸金"的 14 寸屏幕上
      - 开始菜单设计不如 win10 的磁贴实用
      - 取消了很多快捷键，弱化了键盘交互
    - win11 的特色功能“安卓子系统”和“Copilot in Windows”都是有限制国家/地区的
    - 系统更新频繁，稳定性不免让人担忧

2.  现在重装 windows 系统还是挺方便的。记得多年前自己第一次装系统时，即使看了很多的教程资料，但是制作启动盘，进 pe 设置等等，还是搞得一头雾水。现在网速快了很多，可以直接从云端下载系统镜像再一键安装，我只需要点几次“下一步”就可以了，省心了不少。
